...
static int CmdSet(int argc, char** argv) {
    ...
    if (!sel) { printf("usage: upperscale_config.exe set <index|0xLUID> [--dir path] [--enable 1|0] [--log N]\n"); return 2; }
...
int main(int argc, char** argv) {
    ...
    printf("  set <idx|0xLUID> [opts]  write upperscale.ini (--dir, --enable, --log)\n");
